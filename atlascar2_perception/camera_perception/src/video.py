...
#  [-1.23980503e-01, 9.34388247e-01,  4.56377456e+01],
#  [-3.02332816e-04, -1.58373645e-05,  1.00000000e+00]])

        # real_2
    #     self.saved_homo_matrix = np.array([[ 3.04470046e-01, -4.15755362e-02,  8.16567001e+02],
    ...
    def stitch(self, images, ratio=0.75, reproj_thresh=4.0):
        ...
        if self.saved_homo_matrix is None:
            ...
            # img_matches = self.draw_matches(image_a,image_b,keypoints_a,keypoints_b,matched_keypoints[0],matched_keypoints[2])
            # img_matches = imutils.resize(img_matches, height=600)
        ...
        output_shape = (image_a.shape[1] + image_b.shape[1], image_b.shape[0])
    ...
    def run(self):
        ...
        if not(left_video is None and right_video is None):
            ...
            stitched_frame = imutils.resize(stitched_frame, height=500)
