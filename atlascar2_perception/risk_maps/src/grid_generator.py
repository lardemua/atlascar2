...
def callback_sub(marker_data):
	...
	# risk_1 = prob_machine_riskgen(car_count,originX, originY -20, objectList, vxmy, vymy, 2)
	...
	# 	file_exists = os.path.isfile('/home/rafael/Dados/Dados_real/ped.csv')
	# 	with open('/home/rafael/Dados/Dados_real/ped.csv', mode='a', newline='') as file:
